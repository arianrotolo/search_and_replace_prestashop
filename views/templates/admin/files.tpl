...
<div class="panel">
    ...
    <div class="form-wrapper">
        ...
        <div class="form-group row">
            <img class="bt-effect img-responsive" src="https://piscihogar.com/img/mail-2023/plan-renove-mail.webp">
        </div>
        <div class="form-group row">
            <img class="bt-effect img-responsive" src="https://piscihogar.com/img/mail-2023/cupones-descuento.webp">
        </div>
    </div>
